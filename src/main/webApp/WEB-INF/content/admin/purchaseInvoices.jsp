...
<form method="post" action="${pageContext.request.contextPath}/admin/purchaseInvoices">
    <div class="container">
        <div class="row">
...
<div class="modal fade" id="invoiceModalWindow">
    <div class="modal-dialog" style="width: 700px">
        <div class="modal-content">
            ...
            <form action="${pageContext.request.contextPath}/admin/purchaseInvoices" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="contractorsInvoiceNum" class="control-label col-sm-4">Накладная контрагента:</label>
                    <div class="col-sm-6">
                        <input id="contractorsInvoiceNum" type="text" class="form-control" name="contractorsInvoiceNum" value="${invoiceForEditing.invoiceIdFromContractor}">
                    </div>
                </div>
            ...
            <div class="modal-body">
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <c:forEach items="${allIngredients}" var="ingredient">
                        <tr>
                            <td>${ingredient.id}</td>
                            <td><a href="${pageContext.request.contextPath}/admin/purchaseInvoices?clickIngredient=${ingredient.id}">${ingredient.ingredientName}</a></td>
